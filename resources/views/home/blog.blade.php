                    ...
                    <div class="single-blog-image">
                        <div class="overlay-effect">
                            <a href="{{ route('berita.show', $berita->id) }}">
                                <img src="{{ asset('uploads/images/' . $berita->image) }}" class="card-img-top" alt="{{ $berita->judul }}" style="width: 100%; height: 380px; object-fit: cover;">
                            </a>
                        </div>
                    </div>
                    <div class="single-blog-text">
                        <div class="blog-date">
                            <span><i class="fa fa-calendar"></i>{{ \Carbon\Carbon::parse($berita->tanggal)->format('d F, Y') }}</span>
                        </div>
