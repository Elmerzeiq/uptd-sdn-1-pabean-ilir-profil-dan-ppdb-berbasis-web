...
<head>
    ...
    <title>UPTD 1 PABEAN LOGIN</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="{{ route('admin.login') }}" class="noble-ui-logo logo-light d-block mb-2">UPTD 1 PABEAN
                                            ILIR<span><br>ADMINLOGIN</span></a>
                                        ...
                                        <form class="forms-sample" method="post" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="login" class="form-control" id="login"
                                                    placeholder="Email/Name" value="{{ old('login') }}" required>
                                            ...
                                            <button type="submit"
                                                ...
                                                <br>
                                                <br>
                                                <a href="{{ route('admin.register') }}" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">Sign up</a></span>
