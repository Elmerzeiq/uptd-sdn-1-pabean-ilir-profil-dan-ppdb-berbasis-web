                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-4 pe-md-0">
                                    <img src="{{ asset('upload/2.png') }}" style="height: 100%; width: 100%;">
                                </div>
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="{{ route('siswa.login') }}"
                                            class="noble-ui-logo logo-light d-block mb-2">UPTD 1 PABEAN
                                            ILIR<span><br>SISWA BARU LOGIN</span></a>
                                        ...
                                        <form class="forms-sample" method="post" action="{{ route('login') }}">
                                            ...
                                            <span>Not a user?
                                                ...
                                                <a href="{{ route('siswa.register') }}"
                                                    class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">Sign
                                                    up</a></span>
